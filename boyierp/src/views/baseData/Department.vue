<template>
  <div>
    <el-form :inline="true" class="demo-form-inline">
      <el-form-item>
        <el-input v-model="searchName" placeholder="部门名称" clearable></el-input>
      </el-form-item>
      ...
      <el-form-item v-if="hasAuth('baseData:department:save')">
        <el-button type="primary" v-if="hasAuth('baseData:department:save')"  @click="dialogVisible = true">新增</el-button>
      </el-form-item>
