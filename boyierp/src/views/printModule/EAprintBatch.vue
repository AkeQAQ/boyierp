        ...
        <div  class='tab_company_out'>
          ...
          <el-row :gutter="0" style="padding-bottom: 0px;margin-bottom: -10px;text-align: center">
            <el-col :span="4"><div class="grid-content bg-purple"></div>
              <time>日期：{{oneDoc.buyInDate}}</time>
            </el-col>
            <el-col :span="6"><div class="grid-content bg-purple">
              <span>供应商：{{oneDoc.supplierName}}</span>
            </div>
            </el-col>
            <el-col :span="9"><div class="grid-content bg-purple">
              <span>供应商单据号：{{oneDoc.supplierDocumentNum}}</span>
            </div>
            </el-col>
            <el-col :span="5"><div class="grid-content bg-purple">
              <span>单号：{{"CGRK"+oneDoc.id}}</span>
            </div>
            </el-col>
          </el-row>
          <table cellpadding='0' cellspacing='0' >
            ...
            <tr v-if="page==getPages(oneDoc)">
              ...
              <td style="text-align: center" colspan='3'>{{chineseTotal(oneDoc.totalAmount)}}</td>
              <td style="text-align: center" colspan='2'>{{oneDoc.totalNum}}</td>
              <td colspan='1'></td>

              <td style="text-align: center" id='total'>{{oneDoc.totalAmount}}</td>
              <td></td>
            </tr>
          ...
          <el-row :gutter="0" style="padding-top: 0px;margin-bottom: 10px">
            ...
            <el-col :span="9" style="text-align: right"><div class="grid-content bg-purple">
